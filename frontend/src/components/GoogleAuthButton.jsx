...
const GoogleAuthButton = ({
  ...
  if (!isConfigured) {
    return (
      <div className="google-auth-placeholder text-center my-2 p-2 rounded-4" style={{
        background: 'rgba(255, 255, 255, 0.05)',
        border: '1px dashed rgba(255, 255, 255, 0.18)',
        backdropFilter: 'blur(10px)'
      }}>
        <div className="d-flex align-items-center justify-content-center gap-2 small" style={{ color: 'var(--text-muted)' }}>
  ...
  return (
    <div className="google-auth-container w-100 d-flex flex-column align-items-center my-2">
      {errorMsg && (
        <div className="liquid-alert liquid-alert-danger w-100 py-2 px-3 small mb-2" role="alert">
      ...
      {loading ? (
        <div className="d-flex align-items-center justify-content-center gap-2 py-2" style={{ color: 'var(--text-muted)' }}>
